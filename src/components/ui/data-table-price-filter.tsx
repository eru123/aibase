...
interface DataTablePriceFilterProps {
    column?: { setFilterValue: (value: any) => void, getFilterValue: () => any }
    title?: string
    value?: [number | undefined, number | undefined]
    onChange?: (value: [number | undefined, number | undefined]) => void
}

export function DataTablePriceFilter({
    title,
    value,
    onChange,
}: DataTablePriceFilterProps) {
